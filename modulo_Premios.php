        ...
        <tbody>
          <?php
             foreach ($premios as $Premio) {
                echo "<tr>";
                echo "<td><img src='../php/uploads/{$Premio['imagen']}' alt='Imagen del premio' width='60'></td>";
                echo "<td>{$Premio['nombre_premio']}</td>";                
                echo "<td>{$Premio['descripcion_premio']}</td>";
                echo "<td>{$Premio['puntos_necesarios']}</td>";
                ...
                echo "<td>
                        <button class='btn btn-sm btn-primary'
                                ...
                                data-nombre='{$Premio['nombre_premio']}'
                                data-descripcion='{$Premio['descripcion_premio']}'
                                data-puntos='{$Premio['puntos_necesarios']}'
                                data-imagen='{$Premio['imagen']}'><i class='fa-solid fa-pen-to-square'></i>
                           Editar
                        </button>
