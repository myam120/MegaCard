        ...
        <tbody>
          <?php
           foreach ($clientes as $cliente) {
                ...
                echo "<td>{$cliente['nombre_cliente']} {$cliente['apellidos_cliente']}</td>";
                echo "<td>{$cliente['direccion_cliente']}</td>";
                echo "<td>{$cliente['correo_cliente']}</td>";
                echo "<td>{$cliente['estado_cliente']}</td>";
                echo "<td>{$cliente['ciudad_cliente']}</td>";
                echo "<td>{$cliente['puntos_cliente']}</td>";
                echo "<td>
                        ...
                        <button class='btn btn-sm btn-warning' data-bs-toggle='modal' data-bs-target='#modalPuntos'><i class='fa-solid fa-plus'></i> Puntos</button>
